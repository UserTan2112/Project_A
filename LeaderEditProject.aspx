               ...
               <div class="col-sm-6">
                  ...
                  <div class="form-group">
                       <label> Enter Project Manager</label>
                        <asp:TextBox ID="txtPManager" CssClass="form-control" runat="server" AutoPostBack="true"  ></asp:TextBox>
                  ...
                  <div class="form-group">
                       <label> ScenarioXiom</label>
                        <asp:TextBox ID="txtScenarioXiom" CssClass="form-control" runat="server" AutoPostBack="true"  ></asp:TextBox>
                  ...
                  <div class="form-group">
                       <label>Bill Of Material</label>
                        <asp:TextBox ID="txtBillOfMaterial" CssClass="form-control" runat="server" AutoPostBack="true" ReadOnly="true" ></asp:TextBox>
                  ...
                  <div class="form-group">
                       ...
                       <asp:TextBox ID="txtQuantity" CssClass="form-control" runat="server" AutoPostBack="true" ReadOnly="true" ></asp:TextBox>
